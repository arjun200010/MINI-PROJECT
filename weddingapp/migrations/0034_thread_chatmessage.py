# Generated by Django 4.2.2 on 2024-02-28 04:13
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('weddingapp', '0033_customisepackage_applicants_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestamp', models.DateTimeField(auto_now_add=True)),
                ('thread', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='chatmessage_thread', to='weddingapp.thread')),
